...
from sleektiv.tests.common import TransactionCase, can_import
from sleektiv.modules.module import get_module_resource
from sleektiv.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('sleektiv.addons.base_import.models.base_import')
