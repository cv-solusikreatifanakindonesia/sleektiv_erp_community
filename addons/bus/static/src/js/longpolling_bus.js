sleektiv.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether sleektiv is focused or not
     *
     * @returns {boolean}
     */
    isSleektivFocused: function () {
        return this._isSleektivFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isSleektivFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isSleektivFocused);
        }
    },
    /**
