sleektiv.define('hr_timesheet.res.config.form', function (require) {
    "use strict";
    ...
    const TimesheetConfigQRCodeMixin = {
        async _renderView() {
            ...
            const google_url = "https://play.google.com/store/apps/details?id=com.sleektiv.SleektivTimesheets";
