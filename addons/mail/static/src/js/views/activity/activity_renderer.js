sleektiv.define('mail.ActivityRenderer', function (require) {
"use strict";
...
/**
 * Owl Component Adapter for ActivityRecord which is KanbanRecord (Sleektiv Widget)
...
/**
 * Owl Component Adapter for KanbanColumnProgressBar (Sleektiv Widget)
