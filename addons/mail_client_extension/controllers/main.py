...
import sleektiv.addons.iap.tools.iap_tools
...
class MailClientExtensionController(http.Controller):
    ...
    def _get_auth_code_data(self, auth_code):
        ...
        signature = sleektiv.tools.misc.hmac(request.env(su=True), 'mail_client_extension', data).encode()
    ...
    def _generate_auth_code(self, scope, name):
        ...
        signature = sleektiv.tools.misc.hmac(request.env(su=True), 'mail_client_extension', auth_message).encode()
    ...
    def _iap_enrich(self, domain):
        ...
        #except sleektiv.addons.iap.models.iap.InsufficientCreditError as ice:
        except sleektiv.addons.iap.tools.iap_tools.InsufficientCreditError:
