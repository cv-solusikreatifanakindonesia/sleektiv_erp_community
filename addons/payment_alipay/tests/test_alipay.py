...
from sleektiv.addons.payment_alipay.controllers.main import AlipayController

@sleektiv.tests.tagged('post_install', '-at_install', 'external', '-standard')
class AlipayTest(PaymentAcquirerCommon):
    ...
    @mute_logger('sleektiv.addons.payment_alipay.models.payment', 'ValidationError')
