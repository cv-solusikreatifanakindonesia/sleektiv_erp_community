...
class StripeTest(StripeCommon):
    ...
    def run(self, result=None):
        with mute_logger('sleektiv.addons.payment.models.payment_acquirer', 'sleektiv.addons.payment_stripe.models.payment'):
    ...
    @patch('sleektiv.addons.payment_stripe.models.payment.request')
    @patch('sleektiv.addons.payment_stripe.models.payment.datetime')
    ...
    def test_handle_checkout_webhook_no_sleektiv_tx(self):
        stripe_object = stripe_mocks.checkout_session_object
