...
from sleektiv import SUPERUSER_ID, _, api, fields, models, registry
from sleektiv.exceptions import UserError
from sleektiv.osv import expression
from sleektiv.tools import float_compare, float_is_zero, html_escape
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product):
        ...
        :type product: :class:`~sleektiv.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~sleektiv.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
