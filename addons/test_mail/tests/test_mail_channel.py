...
from sleektiv.exceptions import AccessError, ValidationError, UserError
...
class TestChannelAccessRights(TestMailCommon):
    ...
    @mute_logger('sleektiv.addons.base.models.ir_model', 'sleektiv.models', 'sleektiv.models.unlink')
...
class TestChannelModeration(TestMailCommon):
    ...
    @mute_logger('sleektiv.addons.mail.models.mail_channel', 'sleektiv.models.unlink')
