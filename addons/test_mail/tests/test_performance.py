...
class TestMailAPIPerformance(BaseMailPerformance):
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('sleektiv.models.unlink', 'sleektiv.tests', 'sleektiv.addons.mail.models.mail_mail')
    ...
    @users('__system__', 'emp')
    @warmup
    @mute_logger('sleektiv.tests', 'sleektiv.addons.mail.models.mail_mail')
