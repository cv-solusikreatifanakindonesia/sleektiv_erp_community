...
class TestWebsiteResetViews(sleektiv.tests.HttpCase):
    ...
    @mute_logger('sleektiv.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('sleektiv.addons.http_routing.models.ir_http', 'sleektiv.addons.website.models.ir_ui_view')
