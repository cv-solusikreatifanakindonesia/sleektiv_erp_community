sleektiv.define('web.WebClient', function (require) {
"use strict";
...
return AbstractWebClient.extend({
    ...
    bind_events: function () {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since sleektiv use hashtag
    ...
    load_menus: function () {
        return (sleektiv.loadMenusPromise || sleektiv.reloadMenus())
            .then(function (menuData) {
                ...
                sleektiv.loadMenusPromise = null;
                return menuData;
            });
    },
