(function () {
    /**
     * Symbol used in ComponentWrapper to redirect Owl events to Sleektiv legacy
     * events.
     */
    sleektiv.widgetSymbol = Symbol('widget');
    ...
    owl.Component.prototype.__trigger = function (component, evType, payload) {
        if (this.env[sleektiv.widgetSymbol]) {
            this.env[sleektiv.widgetSymbol](evType);
        }
