sleektiv.define('web.ajax', function (require) {
"use strict";
...
function get_file(options) {
    ...
    xhr.onload = function () {
        ...
        decoder.onload = function () {
            ...
            try { // Case of a serialized Sleektiv Exception: It is Json Parsable
...
var loadAsset = (function () {
    ...
    var load = function loadAsset(xmlId, context, tplRoute = '/web/dataset/call_kw/') {
        ...
        context = _.extend({}, sleektiv.session_info.user_context, context);
        const params = {
            args: [xmlId, {
