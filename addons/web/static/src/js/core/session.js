...
var Session = core.Class.extend(mixins.EventDispatcherMixin, {
    ...
    init: function (parent, origin, options) {
        ...
        options = options || {};
        this.module_list = (options.modules && options.modules.slice()) || (window.sleektiv._modules && window.sleektiv._modules.slice()) || [];
        this.server = null;
    ...
    session_reload: function () {
        var result = _.extend({}, window.sleektiv.session_info);
