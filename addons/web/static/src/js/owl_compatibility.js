sleektiv.define('web.OwlCompatibility', function () {
    "use strict";

    /**
     * This file defines the necessary tools for the transition phase where Sleektiv
    ...
    const widgetSymbol = sleektiv.widgetSymbol;
     ...
     * adapter for Owl components that embed Sleektiv legacy widgets (or dynamically
     * both Owl components and Sleektiv legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect Sleektiv legacy events to OWL events.
         *
         * @private
     ...
     * together when an Sleektiv legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * Sleektiv legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
