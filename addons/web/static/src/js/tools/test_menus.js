(function (exports) {
    ...
    let isEnterprise = sleektiv.session_info.server_version_info[5] === 'e';

    function createWebClientHooks() {
        var AbstractController = sleektiv.__DEBUG__.services['web.AbstractController'];
        var DiscussWidget = sleektiv.__DEBUG__.services['mail/static/src/widgets/discuss/discuss.js'];
        var WebClient = sleektiv.__DEBUG__.services["web.WebClient"];
