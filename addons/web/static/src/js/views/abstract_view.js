sleektiv.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Sleektiv JS views are the
 ...
 * the word 'view' has historical significance in Sleektiv code, so we replaced the
