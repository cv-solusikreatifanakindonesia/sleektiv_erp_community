sleektiv.define('web.owl_dialog_tests', function (require) {
    "use strict";
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for Sleektiv modal...
            ...
            // Title (default: 'Sleektiv')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "Sleektiv" + "The Subtitle",
