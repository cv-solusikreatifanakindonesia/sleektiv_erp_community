 ...
 * QUnit Config
 *
 * The Sleektiv javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * Sleektiv.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an Sleektiv module, because we want this code to be executed
 * as soon as possible, not whenever the Sleektiv module system feels like it.
 */
 ...
 * this is done outside of sleektiv modules, otherwise the setting would not take
 * effect on time.
 */
...
async function checkModules() {
    ...
    await sleektiv.__DEBUG__.didLogInfo;

    const info = sleektiv.__DEBUG__.jsModules;
 ...
 */
QUnit.on('SleektivAfterTestHook', function (info) {
