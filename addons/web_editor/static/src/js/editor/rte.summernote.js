sleektiv.define('web_editor.rte.summernote', function (require) {
'use strict';
...
// outside the iframe.
const topBus = window.top.sleektiv.__DEBUG__.services['web.core'].bus;
...
// Sleektiv editor coming in future versions.
...
renderer.createPalette = function ($container, options) {
    ...
    const parent = sleektiv.__DEBUG__.services['root.widget'];
...
// Translation for sleektiv
$.summernote.lang.sleektiv = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),
