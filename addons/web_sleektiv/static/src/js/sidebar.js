sleektiv.define('web_sleektiv.sidemenu', function (require) {
    "use strict";
...
sleektiv.define('web_sleektiv.sidemenu.AppsMenu', function (require) {
    "use strict";
    var AppsMenu = require('web.AppsMenu');
    var SideMenu = require('web_sleektiv.sidemenu');
    AppsMenu.include({
...
sleektiv.define('web_sleektiv.sidemenu.webclient', function (require) {
    "use strict";
