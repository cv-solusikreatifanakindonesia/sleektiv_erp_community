function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('sleektiv-google-map'), {
        zoom: 1,
    ...
    if (sleektiv_partner_data){ /* sleektiv_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < sleektiv_partner_data.counter; i++) {
            set_marker(sleektiv_partner_data.partners[i]);
        }
