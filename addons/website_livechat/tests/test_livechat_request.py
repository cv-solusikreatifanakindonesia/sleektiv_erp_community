...
class TestLivechatRequestHttpCase(tests.HttpCase, TestLivechatCommon):
    ...
    def _common_chat_request_flow(self):
        ...
        self.assertEqual(channel.message_ids[0].author_id, self.env.ref('base.partner_root'), "Sleektivbot must be the sender of the 'has left the conversation' message.")
