...
from sleektiv.exceptions import MissingError, UserError, ValidationError, AccessError
from sleektiv.osv import expression
from sleektiv.tools.safe_eval import safe_eval, test_python_expr
...
# To return an action, assign: action = {...}\n\n\n\n"""
    ...
    def _get_eval_context(self, action=None):
        ...
        eval_context.update({
            ...
            'model': model,
            # Exceptions
            'Warning': sleektiv.exceptions.Warning,
            'UserError': sleektiv.exceptions.UserError,
            # record
            'record': record,
            'records': records,
            # helpers
