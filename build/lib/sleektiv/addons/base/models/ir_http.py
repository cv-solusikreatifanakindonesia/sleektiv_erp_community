...
import sleektiv
from sleektiv import api, http, models, tools, SUPERUSER_ID
from sleektiv.exceptions import AccessDenied, AccessError, MissingError
from sleektiv.http import request, content_disposition
from sleektiv.tools import consteq, pycompat
from sleektiv.tools.mimetypes import get_extension, guess_mimetype
from sleektiv.modules.module import get_resource_path, get_module_path

from sleektiv.http import ALLOWED_DEBUG_MODES
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(sleektiv.conf.server_wide_modules)
            if tools.config['test_enable'] and sleektiv.modules.module.current_test:
                installed.add(sleektiv.modules.module.current_test)
