...
from sleektiv.tools import ustr, pycompat, formataddr, encapsulate_email, email_domain_extract
...
class IrMailServer(models.Model):
    ...
    def _get_default_bounce_address(self):
        ...
        postmaster = get_param('mail.bounce.alias', default='postmaster-sleektiv')
