...
from sleektiv.tools import pycompat, unique, OrderedSet
from sleektiv.tools.safe_eval import safe_eval, datetime, dateutil, time
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in sleektiv.modules.loading.
        if not self._context.get(MODULE_UNINSTALL_FLAG):
