...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - sleektiv/addons/test_access_rights/tests/test_feedback.py
        # - sleektiv/addons/test_access_rights/tests/test_ir_rules.py
        # - sleektiv/addons/base/tests/test_orm.py (/home/dle/src/sleektiv/master-nochange-fp/sleektiv/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
