...
from sleektiv.modules.module import get_module_root, MANIFEST_NAMES
from sleektiv.service.db import _create_empty_database, DatabaseExists
...
class Start(Command):
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            sleektiv.tools.config['init']['base'] = True
