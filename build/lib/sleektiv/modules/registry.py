...
from sleektiv.sql_db import TestCursor
from sleektiv.tools import (config, existing_tables, ignore,
                        lazy_classproperty, lazy_property, sql, OrderedSet)
from sleektiv.tools.lru import LRU

_logger = logging.getLogger(__name__)
_schema = logging.getLogger('sleektiv.schema')
...
class Registry(Mapping):
    ...
    def __new__(cls, db_name):
        ...
        with cls._lock:
            try:
                ...
                # sleektiv.service.wsgi_server.application
        ...
        with cls._lock:
            with sleektiv.api.Environment.manage():
                ...
                try:
                    ...
                    try:
                        sleektiv.modules.load_modules(registry._db, force_demo, status, update_module)
                    except Exception:
                        sleektiv.modules.reset_modules_state(db_name)
                        raise
                except Exception:
    ...
    def init(self, db_name):
        ...
        self._init = True
        self._assertion_report = sleektiv.tests.runner.FlectraTestResult()
        ...
        self._db = sleektiv.sql_db.db_connect(db_name)
        ...
        with closing(self.cursor()) as cr:
            self.has_unaccent = sleektiv.modules.db.has_unaccent(cr)
    ...
    def init_models(self, cr, model_names, context, install=True):
        ...
        env = sleektiv.api.Environment(cr, SUPERUSER_ID, context)
