...
class FlectraPdfFileWriter(PdfFileWriter):
    ...
    def embed_sleektiv_attachment(self, attachment, subtype=None):
        assert attachment, "embed_sleektiv_attachment cannot be called without attachment."
