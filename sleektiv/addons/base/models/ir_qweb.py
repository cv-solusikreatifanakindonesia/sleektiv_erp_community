...
from sleektiv.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from sleektiv.tools.misc import get_lang
from sleektiv.http import request
from sleektiv.modules.module import get_resource_path

from sleektiv.addons.base.models.qweb import QWeb, Contextifier
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from sleektiv.addons.web.controllers.main import module_boot
