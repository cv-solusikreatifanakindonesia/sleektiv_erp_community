...
from sleektiv.tools import pycompat, freehash
from sleektiv.tools.misc import html_escape as escape
from sleektiv.tools.safe_eval import check_values
    ...
    def _base_module(self):
        ...
        * to_text (empty string for a None or False, otherwise unicode string)
        ...
        return ast.parse(dedent("""
            from collections import OrderedDict
            from sleektiv.tools.pycompat import to_text
            from sleektiv.addons.base.models.qweb import escape, foreach_iterator
            """))
