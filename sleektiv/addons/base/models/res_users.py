...
from sleektiv.exceptions import AccessDenied, AccessError, UserError, ValidationError
from sleektiv.http import request
from sleektiv.modules.module import get_module_resource
from sleektiv.osv import expression
from sleektiv.service.db import check_super
from sleektiv.tools import partition, collections, frozendict, lazy_property, image_process
...
class Users(models.Model):
    ...
    def _get_default_image(self):
        """ Get a default image when the user is created without image
            ...
            https://github.com/sleektiv/sleektiv/blob/11.0/sleektiv/addons/base/res/res_partner.py
        """
    ...
    def change_password(self, old_passwd, new_passwd):
        ...
        :return: True
        :raise: sleektiv.exceptions.AccessDenied when old password is wrong
        :raise: sleektiv.exceptions.UserError when new password is not set or empty
        """
        if not old_passwd:
            raise AccessDenied()
        if not new_passwd:
