...
from sleektiv.tools.mimetypes import guess_mimetype, get_extension
...
class test_guess_mimetype(BaseCase):
    ...
    def test_default_mimetype_empty(self):
        ...
        # sleektiv implementation returns application/octet-stream by default
    ...
    def test_mimetype_svg(self):
        ...
        # Tests that whitespace padded SVG are not detected as SVG in sleektiv implementation
        if not magic:
