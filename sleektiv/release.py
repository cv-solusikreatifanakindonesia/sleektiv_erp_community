...
product_name = 'Flectra'
description = 'Flectra Server'
long_desc = '''Flectra is a complete ERP and CRM. The main features are accounting (analytic
...
nt_service_name = "sleektiv-server-" + series.replace('~','-')
