...
RPC_VERSION_1 = {
        'server_version': sleektiv.release.version,
        'server_version_info': sleektiv.release.version_info,
        'server_serie': sleektiv.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, sleektiv.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `sleektiv.netsvc.Logger` class.
    return True
